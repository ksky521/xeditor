  ...
  (function () {
    function T (a) {
      function d (e) {
        ...
        if (b !== 92) return b
        var a = e.charAt(1)
        return (b = w[a]) ? b : a >= '0' && a <= '7' ? parseInt(e.substring(1),
          8) : a === 'u' || a === 'x' ? parseInt(e.substring(2), 16) : e.charCodeAt(
          1)
      }
      ...
      function b (e) {
        ...
        for (var a = a ? 1 : 0, g = b.length; a < g; ++a) {
          ...
          if (/\\[bdsw]/i.test(h)) c.push(h)
            ...
            e.push([h, k])
            k < 65 || h > 122 || (k < 65 || h > 90 || e.push([Math.max(65, h) |
              32, Math.min(k, 90) | 32
            ]), k < 97 || h > 122 || e.push([Math.max(97, h) & -33, Math.min(
              k, 122) & -33]))
          }
        }
        e.sort(function (e, a) {
    ...
    function V (a) {
      for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) {
        var b = f.nodeType,
          d = b === 1 ? d ? a : f : b === 3 ? W.test(f.nodeValue) ? a : d : d
      }
      return d === a ? void 0 : d
    }
        ...
        for (var l = a.i, m = a.h, c = [l, 'pln'], p = 0, w = a.a.match(v) || [],
          ...
          if (typeof q === 'string') h = !1
            ...
            if (k) g = z.match(k[1]), q = k[0]
              ...
              g || (q = 'pln')
            }!(h = q.length >= 5 && q.substring(0, 5) === 'lang-') || g &&
              typeof g[1] === 'string' || (h = !1, q = 'src')
            h || (r[z] = q)
          }
          k = p
          p += z.length
    ...
    function y (a) {
      ...
      b && (a.cStyleComments ? (b > 1 ? d.push(['com',
        /^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/, null, '#'
      ]) : d.push(['com',
    ...
    var Y = E.PR = {
        ...
        prettyPrint: E.prettyPrint = function (a, d) {
          function f () {
            for (var b = E.PR_SHOULD_USE_CONTINUATION ? c.now() + 250
              ...
              for (var d = t[p], l = g, m = d; m = m.previousSibling;) {
                var n = m.nodeType,
                  u = (n === 7 || n === 8) && m.nodeValue
                if (u ? !/^\??prettify\b/.test(u) : n !== 3 || /\S/.test(m.nodeValue)) { break }
                if (u) {
                  l = {}
                ...
                if (!n) {
                  ...
                  if (y.test(d.tagName)) u = 1
                    ...
                    var u = d.currentStyle,
                      x = v.defaultView,
                      u = (u = u ? u.whiteSpace : x && x.getComputedStyle
                      ? x.getComputedStyle(d, null).getPropertyValue(
                        'white-space') : 0) && u.substring(0, 3) === 'pre'
                  }
                  x = l.linenums;
                  (x = x === 'true' || +x) || (x = (x = m.match(
            ...
            p < t.length ? E.setTimeout(f, 250) : typeof a === 'function' &&
              a()
          }
          for (var b = d || document.body, v = b.ownerDocument || document,
            ...
            b.length; ++n) { for (var l = 0, m = b[n].length; l < m; ++l) t.push(b[n][l]) }
          var b = null,
            c = Date
          c.now || (c = {
            now: function () {
      ...
      H = E.define
    typeof H === 'function' && H.amd && H('google-code-prettify', [],
      function () {
        return Y
      })
  })()
